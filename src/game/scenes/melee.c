...
static void render_pilot_select(melee_local *local, bool player2_is_selectable) {
    ...
    // player bio
    text_render(&tconf_green, TEXT_DEFAULT, 4, 66, 156, 34, lang_get2_offset(LANG2_STR_PILOTDESCRIPTION, current_a));
    // player stats
    text_render(&tconf_green, TEXT_DEFAULT, 74, 4, 85, 6, lang_get2(LANG2_STR_PILOTSTAT_POWER));
    text_render(&tconf_green, TEXT_DEFAULT, 74, 22, 85, 6, lang_get2(LANG2_STR_PILOTSTAT_SPEED));
    text_render(&tconf_green, TEXT_DEFAULT, 74, 40, 85, 6, lang_get2(LANG2_STR_PILOTSTAT_ENDURANCE));
    ...
    if(player2_is_selectable) {
        // player 2 name
        text_render(&tconf_black, TEXT_DEFAULT, 320 - 66, 52, 66, 6, lang_get2_offset(LANG2_STR_PILOT, current_b));
        ...
        // 'choose your pilot'
        text_render(&tconf_green, TEXT_DEFAULT, 160, 97, 160, 6, lang_get2(LANG2_STR_CHOOSEYOUR_PILOT));
    }

    // player 1 name
    text_render(&tconf_black, TEXT_DEFAULT, 0, 52, 66, 6, lang_get2_offset(LANG2_STR_PILOT, current_a));
...
static void render_har_select(melee_local *local, bool player2_is_selectable) {
    ...
    // player 1 name
    text_render(&tconf_black, TEXT_DEFAULT, 0, 52, 66, 6, lang_get2_offset(LANG2_STR_PILOT, local->pilot_id_a));

    if(player2_is_selectable) {
        // player 2 name
        text_render(&tconf_black, TEXT_DEFAULT, 320 - 66, 52, 66, 6,
                    lang_get2_offset(LANG2_STR_PILOT, local->pilot_id_b));
        ...
        // 'choose your Robot'
        text_render(&tconf_green, TEXT_DEFAULT, 160, 97, 160, 6, lang_get2(LANG2_STR_CHOOSEYOUR_ROBOT));
