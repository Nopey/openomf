...
component *lab_menu_confirm_create(scene *s, lab_menu_select_cb yes, void *yesdata, lab_menu_select_cb no, void *nodata,
    ...
    component *button =
        spritebutton_create(&tconf, lang_get2(LANG2_STR_YES), bsprite->data, COM_ENABLED, lab_menu_confirm_yes, yesgo);
    ...
    button =
        spritebutton_create(&tconf, lang_get2(LANG2_STR_NO), bsprite->data, COM_ENABLED, lab_menu_confirm_no, nogo);
